	...
	<div class="block-container">
		...
		<div class="col-md-12" style="color:black">
            <div class="card card-default">
			  ...
			  <a style="float:right" href="<?php echo $config->baseURL.'layar/show-layar-antrian?id=all'?>" class="btn btn-danger"><i class="fa fa-times"></i></a>
                <h3 class="card-title">
                  <i class="fas fa-bullhorn"></i>
                  <?php echo $layanan['nama_antrian_kategori'] ?>
                </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
			 <?php foreach ($daftar_layanan as $val) {
				?>
                <div class="callout callout-list">
                  <h5><?php echo $val['nama_layanan'] ?></h5>
				...
				<span class="input-group-append">
                    <a href="<?php echo $config->baseURL.'/layar/show-layar-antrian-detail-layanan?id='.$val['id']?>" class="btn btn-warning btn-flat">Cek Layanan</a>
                  </span>
				</div>
				</div>
